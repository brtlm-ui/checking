                            ...
                            <div class="table-responsive">
                                <table class="table table-sm">
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($todayRecord['am_in_status']): ?>
                                                <span class="badge bg-<?php echo $todayRecord['am_in_status'] === 'ON TIME' ? 'success' : 'warning'; ?>">
                                                    <?php echo $todayRecord['am_in_status']; ?>
                                                </span>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($todayRecord['am_out_status']): ?>
                                                <span class="badge bg-<?php echo $todayRecord['am_out_status'] === 'ON TIME' ? 'success' : 'warning'; ?>">
                                                    <?php echo $todayRecord['am_out_status']; ?>
                                                </span>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($todayRecord['pm_in_status']): ?>
                                                <span class="badge bg-<?php echo $todayRecord['pm_in_status'] === 'ON TIME' ? 'success' : 'warning'; ?>">
                                                    <?php echo $todayRecord['pm_in_status']; ?>
                                                </span>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($todayRecord['pm_out_status']): ?>
                                                <span class="badge bg-<?php echo ($todayRecord['pm_out_status'] === 'OVERTIME') ? 'info' : (($todayRecord['pm_out_status'] === 'ON TIME') ? 'success' : 'warning'); ?>">
                                                    <?php echo $todayRecord['pm_out_status']; ?>
                                                </span>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
